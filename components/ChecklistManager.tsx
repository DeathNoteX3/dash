                ...
                <div key={stage.id} className="bg-white dark:bg-yt-dark-gray rounded-xl border border-gray-200/80 dark:border-yt-light-gray/60 p-5">
                    ...
                    <div className="space-y-3">
                        ...
                        {addingTaskToStage === stage.id ? (
                             <form onSubmit={(e) => { e.preventDefault(); handleAddTask(stage.id, e.currentTarget.taskLabel.value); }} className="flex items-center gap-2 p-2 rounded-lg bg-gray-50 dark:bg-yt-black/50">
                                <input
                                    name="taskLabel"
                                    type="text"
