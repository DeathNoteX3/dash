...
export interface IElectronAPI {
  ...
  removeMaximizedStateListener: () => void;
  // FIX: Add missing method definitions for image management to fix type errors.
  listImages: (projectPath: string, productIndex: number) => Promise<string[]>;
  getImageAsBase64: (path: string) => Promise<string>;
  downloadImage: (projectPath: string, productIndex: number, imageUrl: string) => Promise<string | undefined>;
